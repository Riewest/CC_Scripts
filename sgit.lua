-- Copied from: https://github.com/Phaysik/minecraftTurtles/blob/master/updateScripts.lua
-- With some slight changes to work for my use case a little better

local args = {...}
local githubName = "Riewest"
local repositoryName = "CC_Scripts" -- The repository must be public for this script to work
local devBranch = args[1] or "main"
